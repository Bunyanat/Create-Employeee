            ...
            {!showPhotoPreview && (
                <>
                    {employees.data.length > 0 && ( //เช็คว่ามีข้อมูลพนักงานหรือไม่ ถ้ามีให้แสดงหัวข้อและฟอร์มค้นหา
                        <>
                            <h1 style={{ fontSize: '2.3em', fontWeight: 'bold', textAlign: 'center', margin: '40px 50px', color: '#c1da92' }}>Employees List</h1>
                            {/*ฟอร์มค้นหาพนักงาน*/}
                            <form onSubmit={handleSearch} style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '50px' }}>
                                ...
                                />
                                <button type="submit" style={{ padding: '10px 20px', borderRadius: '5px', border: 'none', backgroundColor: '#c1da92', color: '#fff', cursor: 'pointer' }}>
                                    Search
                                </button>
                            </form>
                        </>
                    ...
                    {employees.data.length === 0 ? ( //แต่ถ้าไม่มีข้อมูลพนักงานให้แสดงข้อความว่า Employee Not Found
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '85vh', position: 'relative' }}>
                            ...
                            <button style={{ textDecoration: 'underline' }}
                                onMouseOver={(e) => { e.target.style.color = '#c1da92'; }}
                                        ...
                                        return pageNumbers.map((page, index) => (
                                            <button
                                                ...
                                                style={{
                                                    margin: '0 5px',
                                                    padding: '10px 15px',
                                                    backgroundColor: page === currentPage ? '#c1da92' : '#fff',
                                                    color: page === currentPage ? '#fff' : '#c1da92',
                                                    border: '1px solid #ddd',
                                                    borderRadius: '5px',
